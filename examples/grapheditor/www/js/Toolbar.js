...
export class Toolbar {
  constructor(editorUi, container) {
    ...
    this.vsplit2_bottun = null;
    this.hsplit2_bottun = null;
...
*/
  ...
  split[3].setAttribute(
    "title",
    m.mxResources.get("vsplit2") +
      " (" +
      this.editorUi.actions.get("vsplit2").shortcut +
      ")",
  );
  split[4].setAttribute(
    "title",
    m.mxResources.get("hsplit2") +
      " (" +
...
Toolbar.prototype.toggle_select_pan = function (pan) {
  if (pan) {
    this.select_bottun.className = this.select_bottun.className.replace(
      "geButtonToggleOn",
      "",
    );
    this.pan_bottun.className = this.pan_bottun.className.concat(
      " ",
      "geButtonToggleOn",
    );
  } else {
    this.select_bottun.className = this.select_bottun.className.concat(
      " ",
      "geButtonToggleOn",
    );
    this.pan_bottun.className = this.pan_bottun.className.replace(
      "geButtonToggleOn",
      "",
    );
  }
