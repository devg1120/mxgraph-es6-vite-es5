...
export class EditorUi extends m.mxEventSource {
  ...
  constructor(editor, container, lightbox) {
    ...
    if (!graph.standalone) {
      ...
      this.editor3.resetGraph();
      this.editor3.graph.sizeDidChange();
      this.editor4.resetGraph();
      this.editor4.graph.sizeDidChange();
  ...
  graph_init(graph) {
    ...
    graph.panningHandler.isForcePanningEvent = function (me) {
      ...
      return (
        ...
        spaceKeyPressed ||
        (m.mxEvent.isMouseEvent(me.getEvent()) &&
          (this.usePopupTrigger || !m.mxEvent.isPopupTrigger(me.getEvent())) &&
          ((!m.mxEvent.isControlDown(me.getEvent()) &&
            m.mxEvent.isRightMouseButton(me.getEvent())) ||
            m.mxEvent.isMiddleMouseButton(me.getEvent())))
      );
...
/*
    ...
    // Create handler for key events
    this.keyHandler3 = this.createKeyHandler(this.editor3);

    // Getter for key handler
    this.getKeyHandler3 = function () {
      return keyHandler3;
    };
    // Create handler for key events
    this.keyHandler4 = this.createKeyHandler(this.editor4);

    // Getter for key handler
    this.getKeyHandler4 = function () {
      return keyHandler4;
    };
*/
    // Stores the current style and assigns it to new cells
...
EditorUi.prototype.resetScrollbars = function () {
  ...
  this.resetScrollbars_imp(this.editor3.graph);
  this.resetScrollbars_imp(this.editor4.graph);
};
...
*/
  ...
  /***********************************************/
  con = document.getElementById("split3"); // GS
  this.editor3 = new Editor( // GS
    this.editor.chromeless,
    themes,
    model,
    null,
  ...
  var graph3 = this.editor3.graph;
  graph3.lightbox = lightbox;
  graph3.name = "G3";
  graph3.init(con);
  this.initCanvas(graph3);
  this.graph_init(graph3);
  this.hoverIcons3 = this.createHoverIcons(graph3); //GS
  /***********************************************/
  con = document.getElementById("split4"); // GS
  this.editor4 = new Editor( // GS
    this.editor.chromeless,
    themes,
    model,
    null,
  ...
  var graph4 = this.editor4.graph;
  graph4.lightbox = lightbox;
  graph4.name = "G4";
  graph4.init(con);
  this.initCanvas(graph4);
  this.graph_init(graph4);
  this.hoverIcons4 = this.createHoverIcons(graph4); //GS
  /********************************************/
...
*/
  ...
  //sp1.className = "split1";
  //sp1.id = "split1";
  var sp1 = this.createSplitChildDivHorizontal("split1", "split2")
  //var sp2 = document.createElement("div");
  //sp2.className = "split2";
  //sp2.id = "split2";
  var sp2 = this.createSplitChildDivHorizontal("split3", "split4")
  sp2.style.height = "300px";
  var gutter = document.createElement("div");
  gutter.className = "gutter";
  elt.appendChild(sp1);
...
EditorUi.prototype.select = function () {
  ...
  c = this.editor3.graph.container;
  if (c != undefined) {
    c.style.cursor = "default";
  }
  c = this.editor4.graph.container;
  if (c != undefined) {
    c.style.cursor = "default";
  }
};
...
EditorUi.prototype.diagram_hsplit = function () {
  ...
  */
  ...
  ele.children[0].children[0].style.width= "100%";
  ele.children[0].children[0].style.height= "100%";
  ele.children[0].children[2].style.width= "0%";
  ele.children[0].children[2].style.height= "100%";

  ele.children[2].children[0].style.width= "100%";
  ele.children[2].children[0].style.height= "100%";
  ele.children[2].children[2].style.width= "0%";
