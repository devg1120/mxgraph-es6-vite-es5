...
function main(container) {
  ...
  console.log("mxClient.basePath", m.mxClient.basePath);
  ...
  if (!m.mxClient.isBrowserSupported()) {
    ...
    var rubberband = new m.mxRubberband(graph);
    new m.mxKeyHandler(graph);
    ...
    m.mxUtils.write(content, lorem + lorem + lorem);
