...
(function () {
  ...
  (function () {
    ...
    function x(a) {
      return (
        e[a] ||
        (e[a] = ("\u0010" > a ? "%0" : "%") + a.charCodeAt(0).toString(16))
      );
    }
    var E = { "\\": "\\\\" },
      e = { "\\": "%5c" },
  ...
  "undefined" !== typeof window &&
    ((window.lexCss = U), (window.decodeCss = X));
  var Y = (function () {
    function g(d) {
      d = ("" + d).match(k);
      return !d
        ? s
        : new e(v(d[1]), v(d[2]), v(d[3]), v(d[4]), v(d[5]), v(d[6]), v(d[7]));
    }
    function w(d, a) {
    ...
    function x(d) {
      if (d === s) return s;
      for (
        var d = d.replace(/(^|\/)\.(?:\/|$)/g, "$1").replace(/\/{2,}/g, "/"),
          a = b,
          h;
        (h = d.replace(a, "$1")) != d;
        d = h
              ...
              if ((D = u.cssLitGroup)) {
                ...
                if (!(G = u.cssLitMap)) {
                  ...
                  for (var K = D.length; 0 <= --K; )
                    for (var A = D[K], T = A.length; 0 <= --T; ) G[A[T]] = a;
                  G = u.cssLitMap = G;
                }
                D = G;
              } else D = a;
              if (!((w = D), w[E(j)] === a))
                if (35 === I && /^#(?:[0-9a-f]{3}){1,2}$/.test(j))
                  j = i & 2 ? j : "";
                  ...
                  j =
                    k && i & 16
                      ? g(x(M(e, b[r].substring(5, j.length - 2)), f, k))
                      : "";
                  ...
                  j =
                    B && /^-?[a-z_][\w\-]*$/.test(j) && !/__$/.test(j)
                      ...
                      ? F + 1 === o
                        ? ((b[F] =
                            b[F].substring(0, b[F].length - 1) + " " + j + '"'),
                          "")
                        : ((F = o), '"' + j + '"')
                      : "";
            }
        ...
        fa(g, {
          ...
          startAtrule: function (g, j) {
            if (r) g = s;
              ...
              var i = j[0];
              1 === j.length && !/__$|[^\w\-]/.test(i)
                ? (q.push(g, " ", i + k.L), (g = "@keyframes"))
                : (g = s);
              ...
              if (((g = s), "function" === typeof w)) {
                ...
                window.console &&
                  window.console.log("@import " + j.join(" ") + " elided");
            r = !g;
            F.push(g);
          },
          endAtrule: function () {
  ...
  (function () {
    ...
    var v = /^-?[a-z]/i;
    ga = function (b, a) {
      for (var g = U(b), f = 0, h = g.length; f < h; )
        f = " " !== g[f] ? e(g, f, h, a) : f + 1;
    };
  })();
  "undefined" !== typeof window &&
  ...
  var ha = (function (g) {
                ...
                if ((h = /^([-\w:]+)[^\'\"]*/.exec(l)))
                  if (h[0].length === l.length && ">" === d[p + 1])
                    ...
                    var m = d,
                      ...
                      w = f(m, q);
                    w
                      ? (r.t && r.t(w.name, u, v, b(r, m, q, y, u)),
                        (p = w.next))
                      : (p = m.length);
                  }
      ...
      function k(a, d, f, h, t, j) {
        ...
        for (
          var i = T[d.name], k = d.next, l = d.next + 1;
          l < z && !("</" === a[l - 1] && i.test(a[l]));
          l++
        );
        l < z && (l -= 1);
        z = a.slice(k, l).join("");
      ...
      function f(a, b) {
        ...
        f.c = g.f[f.name];
        for (
          var e = a[b].substr(d[0].length), h = b + 1, j = a.length;
          h < j && ">" !== a[h];
          h++
        )
          e += a[h];
      ...
      function V(a, b, f, e, h) {
        for (var j = 0; j < b.length; j += 2) {
          var k = b[j],
            ...
            q;
          if (
            ((q = a + "::" + k), g.m.hasOwnProperty(q)) ||
            ((q = "*::" + k), g.m.hasOwnProperty(q))
          )
            o = g.m[q];
          if (o !== s)
            switch (o) {
