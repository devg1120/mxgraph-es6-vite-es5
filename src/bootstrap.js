...
export function bootstrap() {
  ...
  if (typeof window.mxBasePath != "undefined" && window.mxBasePath.length > 0) {
    if (window.mxBasePath.substring(window.mxBasePath.length - 1) == "/") {
      window.mxBasePath = window.mxBasePath.substring(
        0,
  ...
  if (
    typeof window.mxImageBasePath != "undefined" &&
    window.mxImageBasePath.length > 0
  ) {
    if (
      window.mxImageBasePath.substring(window.mxImageBasePath.length - 1) == "/"
    ) {
      window.mxImageBasePath = window.mxImageBasePath.substring(
        0,
  ...
  if (
    typeof window.mxDefaultLanguage != "undefined" &&
