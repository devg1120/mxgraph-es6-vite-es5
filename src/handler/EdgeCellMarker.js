...
export class EdgeCellMarker extends mxCellMarker {
  ...
  getCell(me) {
    ...
    if (
      (cell == this.edgeHandler.state.cell || cell == null) &&
    ...
    if (cell != null && !this.edgeHandler.graph.isCellConnectable(cell)) {
      ...
      if (
        this.edgeHandler.graph.getModel().isVertex(parent) &&
        this.edgeHandler.graph.isCellConnectable(parent)
      ) {
        cell = parent;
      }
    }
    ...
    if (
      ...
      (cell != null &&
        !this.edgeHandler.graph.connectableEdges &&
        model.isEdge(cell)) ||
